                    ...
                    >
                        ...
                        <div className="flex flex-col items-center text-center relative z-10">
                            ...
                            <p className="text-gray-300 mb-8 text-lg font-light leading-relaxed">
                                Tu misión ha sido registrada en nuestra base de datos. Un agente de <span className="text-neon-cyan font-bold">CyberSkyWeb</span> contactará contigo en breve.
                            </p>
        ...
        try {
            const response = await fetch("https://formsubmit.co/ajax/contact.dronyxair@gmail.com", {
                ...
                body: JSON.stringify({
                    ...
                    _subject: "🚀 Nuevo Proyecto: CyberSkyWeb",
                    _template: "box",
                    _captcha: "false"
                })
            });
