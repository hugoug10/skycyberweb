        ...
        <section id="services" className={`py-24 bg-dark-bg relative overflow-hidden ${preview ? 'py-12' : 'py-24'}`}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    {displayedServices.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center md:text-left">
                                <div className="p-3 rounded-lg bg-white/5 w-fit mb-6 mx-auto md:mx-0 text-neon-cyan group-hover:scale-110 transition-transform duration-300">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-16 mx-4 md:mx-0 relative rounded-3xl overflow-hidden bg-dark-card border border-orange-500/30 group"
                >
                    ...
                    <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                        <div className="p-6 rounded-2xl bg-orange-500/10 text-orange-500 border border-orange-500/20 shadow-[0_0_30px_rgba(249,115,22,0.2)]">
                            <Video size={48} className="md:w-16 md:h-16" />
                        </div>
                        <div className="text-center md:text-left flex-1">
                            <div className="inline-block px-4 py-1 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold mb-4 border border-orange-500/20">
                                NUEVO SERVICIO PREMIUM
                            </div>
                            <h3 className="text-2xl md:text-4xl font-bold text-white mb-4">
                                Videografía con Dron Profesional
                            </h3>
                            <p className="text-gray-300 text-base md:text-lg mb-6 leading-relaxed max-w-3xl">
                                Eleva tu marca con tomas aéreas 4K espectaculares. Ideal para videos corporativos o contenido de alto impacto. Capturamos perspectivas imposibles.
                            </p>
                            <Link to="/contacto" className="w-full md:w-auto inline-block text-center px-8 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white font-black rounded-full hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] transition-all transform hover:scale-105">
