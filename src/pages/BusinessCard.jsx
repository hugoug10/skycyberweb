    ...
    return (
        <div className="min-h-screen bg-neutral-900 flex flex-col items-center justify-center p-8 gap-8 font-sans">
            ...
            <div className="w-full max-w-[500px] flex justify-center">
                <div className="transform scale-[0.65] sm:scale-100 origin-center transition-transform duration-300">
                                ...
                                <div className="w-2/3 flex flex-col justify-between py-1">
                                    ...
                                    <div className="space-y-2 mt-4 bg-white/5 p-4 rounded-lg border border-white/5">
                                        <div className="flex items-center gap-3 text-sm text-gray-300">
                                            ...
                                            <span translate="no" className="notranslate">contact@cyberskyweb.com</span>
                                        </div>
                                        <div className="flex items-center gap-3 text-sm text-gray-300">
