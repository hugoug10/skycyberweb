    ...
    return (
        <div className="pt-24 pb-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 text-gray-300">
                ...
                <p>
                    Si tiene alguna duda, puede escribirnos directamente a <a href="mailto:contact@cyberskyweb.com" className="text-neon-cyan hover:underline notranslate" translate="no">contact@cyberskyweb.com</a>.
                </p>
            </div>
        </div>
    );
