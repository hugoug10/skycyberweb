    ...
    return (
        <div className="pt-24 pb-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 text-gray-300">
                ...
                <p>
                    En SkyCyberWeb, valoramos su privacidad por encima de todo. Queremos ser completamente transparentes: <strong>no recopilamos, almacenamos ni procesamos ningún tipo de dato personal</strong> a través de este sitio web.
                </p>
