    ...
    return (
        <div className="pt-24 pb-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 text-gray-300">
                ...
                <p>
                    Bienvenido a Cyber Sky Web. Al acceder a nuestro sitio web, usted acepta estar sujeto a estos términos y condiciones.
                </p>
                ...
                <p>
                    Todo el contenido de este sitio web, incluyendo texto, gráficos, logotipos e imágenes, es propiedad de Cyber Sky Web y está protegido por las leyes de propiedad intelectual.
                </p>
                <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Limitación de Responsabilidad</h2>
                <p>
                    Cyber Sky Web no será responsable de ningún daño directo, indirecto, incidental, consecuente o punitivo que surja del uso o la imposibilidad de uso de este sitio.
                </p>
            </div>
        </div>
    );
